...
import { ActionTokenSavings } from "./ActionTokenSavings";

interface ActionThinkProps {
  node?: any;
  children?: React.ReactNode;
}

export const ActionThink: React.FC<ActionThinkProps> = ({ children, node }) => {
  ...
  // If it's token savings format, render ActionTokenSavings component
