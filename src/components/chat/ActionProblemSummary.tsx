...
interface ActionProblemSummaryProps {
  summary?: string;
...
export const ActionProblemSummary: React.FC<ActionProblemSummaryProps> = ({
  summary,
  children,
}) => {
  ...
  return (
    ...
    >
      <ActionCardHeader icon={<AlertTriangle size={15} />} accentColor="amber">
        <ActionBadge color="amber">Auto-fix</ActionBadge>
