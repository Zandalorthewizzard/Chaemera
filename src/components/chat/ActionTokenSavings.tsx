...
import { ActionCard, ActionCardHeader } from "./ActionCardPrimitives";

interface ActionTokenSavingsProps {
  originalTokens: number;
  smartContextTokens: number;
}

export const ActionTokenSavings: React.FC<ActionTokenSavingsProps> = ({
  originalTokens,
  smartContextTokens,
}) => {
  ...
  return (
    <Tooltip>
      <TooltipTrigger>
        <ActionCard accentColor="green">
          <ActionCardHeader icon={<Zap size={15} />} accentColor="green">
