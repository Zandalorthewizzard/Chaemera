...
describe("safeJoin", () => {
  ...
  describe("safe paths", () => {
    ...
    it("should handle nested directories", () => {
      ...
      expect(result).toBe(
        normalizedPath(path.join(testBaseDir, "src/pages/home/index.tsx")),
      );
    });
    ...
    it("should handle empty path segments", () => {
      ...
      expect(result).toBe(
        normalizedPath(path.join(testBaseDir, "", "src", "", "file.ts")),
      );
    });
  ...
  describe("edge cases", () => {
    it("should handle Windows-style base paths", () => {
      ...
      expect(result).toBe(
        normalizedPath(path.join(testBaseDirWindows, "src", "file.txt")),
      );
    });
    ...
    it("should handle current directory references safely", () => {
      const result = safeJoin(testBaseDir, "./src/file.txt");
      expect(result).toBe(
        normalizedPath(path.join(testBaseDir, "./src/file.txt")),
      );
    });
    ...
    it("should handle very long paths safely", () => {
      ...
      expect(result).toBe(normalizedPath(path.join(testBaseDir, longPath)));
    });
