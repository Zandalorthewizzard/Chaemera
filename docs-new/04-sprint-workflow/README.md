---
id: chaemera-sprint-hub
title: Sprint Workflow Hub
type: hub
status: draft
tags: [sprint, workflow]
related:
  [
    [runbook.md],
    [spec-template.md],
...
Use this folder to produce sprint packs from discussions.
...
- [[sprints/README.md]]
- [[sprints/sprint-0-baseline-scope-freeze.md]]
- [[sprints/sprint-1-oss-detox.md]]
- [[sprints/sprint-2-tauri2-bootstrap.md]]
