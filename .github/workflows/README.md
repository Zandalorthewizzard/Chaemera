...
| `release.yml`                | `Release Electron Legacy`      | Manually builds and publishes signed Electron/Forge release artifacts across platforms as a fallback path during the Tauri cutover. | `workflow_dispatch`.                                                                                                 | None.                                                                                                                                                                                               |
